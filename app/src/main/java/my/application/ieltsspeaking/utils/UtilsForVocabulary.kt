...
class UtilsForVocabulary {
    companion object {
            ...
            when (answer) {
                1 -> {
                    optionOne.background =
                        ContextCompat.getDrawable(context, drawableView)
                }
                2 -> {
        ...
        fun navigateFragment(myFragment: Fragment, fragmentManager: FragmentManager) {
        ...
        fun alertDialog(context: Context, fragment: Fragment, fragmentManager: FragmentManager) {
            val builder: AlertDialog.Builder = AlertDialog.Builder(context)
            builder.setTitle("GREAT")
                .setMessage("Keep learning. Just keep in mind: Practice makes perfect")
                .setCancelable(false)
                .setPositiveButton("Finish") { _, _ ->
                    navigateFragment(fragment, fragmentManager)
                }.show()
        }
