package my.application.ieltsspeaking.home.category.test_yourself.part1.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import my.application.ieltsspeaking.databinding.ItemsRvTestYourselfPart1Binding
...
class TestYourselfPart1Adapter(
    ...
    inner class TestYourselfPart1ViewHolder(val binding: ItemsRvTestYourselfPart1Binding) :
        ...
        binding.tvTestYourselfPart1Question.text = modelTestYourselfPart1.question
